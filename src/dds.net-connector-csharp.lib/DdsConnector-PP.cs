    ...
    public partial class DdsConnector
    {
        ...
        private bool UpdatePrimitiveVariableWithWord(BasePrimitive bpv, short v)
        {
            ...
            else if (bpv is ByteVariable bt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Word {v} to {bt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedByteVariable ubt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Word {v} to {ubt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedWordVariable uwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Word {v} to {uwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedDWordVariable udwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Word {v} to {udwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedQWordVariable uqwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Word {v} to {uqwrd.GetPrintableTypeName()} {conv}");
        ...
        private bool UpdatePrimitiveVariableWithDWord(BasePrimitive bpv, int v)
        {
            ...
            else if (bpv is ByteVariable bt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {bt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is WordVariable wrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {wrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedByteVariable ubt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {ubt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedWordVariable uwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {uwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedDWordVariable udwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {udwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedQWordVariable uqwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {uqwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is SingleVariable sngl)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting DWord {v} to {sngl.GetPrintableTypeName()} {conv}");
        ...
        private bool UpdatePrimitiveVariableWithUnsignedDWord(BasePrimitive bpv, uint v)
        {
            ...
            else if (bpv is ByteVariable bt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned DWord {v} to {bt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is WordVariable wrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned DWord {v} to {wrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is DWordVariable dwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned DWord {v} to {dwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedByteVariable ubt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned DWord {v} to {ubt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedWordVariable uwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned DWord {v} to {uwrd.GetPrintableTypeName()} {conv}");
        ...
        private bool UpdatePrimitiveVariableWithUnsignedQWord(BasePrimitive bpv, ulong v)
        {
            ...
            else if (bpv is ByteVariable bt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {bt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is WordVariable wrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {wrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is DWordVariable dwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {dwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is QWordVariable qwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {qwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedByteVariable ubt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {ubt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedWordVariable uwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {uwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedDWordVariable udwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Unsigned QWord {v} to {udwrd.GetPrintableTypeName()} {conv}");
        ...
        private bool UpdatePrimitiveVariableWithSingle(BasePrimitive bpv, float v)
        {
            ...
            else if (bpv is ByteVariable bt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {bt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is WordVariable wrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {wrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is DWordVariable dwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {dwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is QWordVariable qwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {qwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedByteVariable ubt)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {ubt.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedWordVariable uwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {uwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedDWordVariable udwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {udwrd.GetPrintableTypeName()} {conv}");
            ...
            else if (bpv is UnsignedQWordVariable uqwrd)
            {
                ...
                Logger.Warning($"Possible loss of received data - converting Single {v} to {uqwrd.GetPrintableTypeName()} {conv}");
